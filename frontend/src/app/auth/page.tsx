...
import { loginUser, registerUser, loginWithToken, googleLogin } from "../../store/slices/authSlice";
...
export default function AuthPage() {
  ...
  const { token, loading, error, user } = useSelector((state: RootState) => state.auth);
